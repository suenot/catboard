...
const uint8_t layer_fn[KEYS] = {
	...
	KEY_F1,				KEYPAD_0,		KEYPAD_PLUS,	KEYPAD_MINUS,	KEY_LAYER1,			// COL2
	KEY_F2,				KEYPAD_1,		KEYPAD_4,		KEYPAD_7,		NULL,				// COL3
	KEY_F3,				KEYPAD_2,		KEYPAD_5,		KEYPAD_8,		KEY_LALT,			// COL4
	KEY_F4,				KEYPAD_3,		KEYPAD_6,		KEYPAD_9,		KEY_LCTRL,			// COL5
	KEY_F5,				KEY_TILDE,		KEYPAD_ASTERIX,	KEYPAD_SLASH,	KEY_MY_SHIFT,		// COL6
	KEY_F6,				KEY_LED,		KEY_ENTER,		KEY_ESC,		KEY_OS_MODE,		// COL7
	KEY_F7,				KEY_HOME,		KEY_LEFT,		KEY_BACKSPACE,	KEY_FN,				// COL8
	KEY_F8,				KEY_UP,			KEY_DOWN,		KEY_DELETE,		KEY_FN_LOCK,		// COL9
	KEY_F9,				KEY_END,		KEY_RIGHT,		KEY_INSERT,		NULL,				// COL10
...
const uint8_t layer_fnlock[KEYS] = {
	...
	KEY_5,				KEY_TILDE,		KEY_ENTER,		KEY_MACRO,		KEY_SPACE,			// COL6
...
const uint8_t layer_fnlock[KEYS] = { //for gaming
	//ROW1				ROW2			ROW3			ROW4			ROW5
	KEY_TILDE,		KEY_TAB,			KEY_RCTRL,		KEY_ALT_TAB,	KEY_ESC,		// COL1
	KEY_1,			KEY_Q,				KEY_A,			KEY_LGUI,		KEY_RSHIFT,		// COL2
	KEY_2,			KEY_W,				KEY_S,			KEY_X,			KEY_Z,			// COL3
	KEY_3,			KEY_E,				KEY_D,			KEY_C,			KEY_LALT,		// COL4
	KEY_4,			KEY_R,				KEY_F,			KEY_V,			KEY_LCTRL,		// COL5
	KEY_5,			KEY_T,				KEY_G,			KEY_B,			KEY_SPACE,		// COL6
	KEY_6,			KEY_Y,				KEY_H,			KEY_N,			KEY_SPACE,		// COL7 
	KEY_7,			KEY_U,				KEY_J,			KEY_M,			KEY_FN,			// COL8
	KEY_8,			KEY_I,				KEY_K,			KEY_COMMA,		KEY_RALT,		// COL9
	KEY_9,			KEY_O,				KEY_L,			KEY_PERIOD,		KEY_SLASH,		// COL10
	KEY_0,			KEY_P,				KEY_SEMICOLON,	KEY_BACKSLASH,	KEY_LSHIFT,		// COL11
	KEY_MINUS,		KEY_LEFT_BRACE,		KEY_QUOTE,		KEY_RIGHT_BRACE,KEY_EQUAL		// COL12
};